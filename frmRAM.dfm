object frmTerceiroRAM: TfrmTerceiroRAM
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmRAM'
  ...
  object pnlSAM: TPanel
    ...
    object gbConfiguracoes: TGroupBox
      ...
      ParentFont = False
      TabOrder = 0
      object btnImportarRAM: TSpeedButton
        Left = 392
        Top = 45
        Width = 161
        Height = 25
        ...
        OnClick = btnImportarRAMClick
      end
      object btnVoltarRAM: TSpeedButton
        Left = 583
        Top = 45
        Width = 161
        Height = 25
        ...
        ParentFont = False
        OnClick = btnVoltarRAMClick
      end
      object txtImportarRAM: TLabeledEdit
        Left = 16
        Top = 46
        Width = 353
        Height = 24
    ...
    object gridProcessos: TRzStringGrid
      ...
      Font.Style = []
      GridLineWidth = 2
      Options = [goVertLine, goHorzLine, goRangeSelect, goDrawFocusSelected, goRowSizing, goColSizing, goRowSelect]
      ParentBiDiMode = False
      ParentFont = False
      TabOrder = 1
    ...
    object gbConsultaSAM: TGroupBox
      ...
      object btlLimparLabel: TSpeedButton
        Left = 328
        Top = 83
        Width = 33
        Height = 25
      ...
      object txtValorTotalRAM: TLabeledEdit
        Left = 256
        Top = 44
        Width = 105
        Height = 24
        ...
        EditLabel.Caption = 'Qtd. de consultas'
        EditLabel.Font.Charset = DEFAULT_CHARSET
        EditLabel.Font.Color = clWindowText
        EditLabel.Font.Height = -13
        EditLabel.Font.Name = 'Tahoma'
        ...
        ParentFont = False
        TabOrder = 1
        OnKeyPress = txtValorTotalRAMKeyPress
      end
    end
    object gbResultadoSAM: TGroupBox
      ...
      ParentFont = False
      TabOrder = 3
      object lblRAMResultadoRAM: TLabel
        Left = 32
        Top = 55
        Width = 238
        Height = 19
      ...
      object lblRAMResultadoSAM: TLabel
        Left = 32
        Top = 25
        Width = 232
        Height = 19
